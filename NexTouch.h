...
#define NEX_EVENT_ON_SHOW   (0xFF) //FAKE 
...
public: /* static methods */    
    ...
    static void iterateOnShow(class NexPage **list, uint8_t pid);
public: /* methods */
    ...
    /**
     * Attach an callback function of onShow page event. 
     *
     * @param onShow - callback called with ptr when a onShow page event occurs. 
     * @param ptr - parameter passed into onShow page[default:NULL]. 
     * @return none. 
     *
     * @note If calling this method multiply, the last call is valid. 
     */
    void attachOnShow(NexTouchEventCb onShow, void *ptr = NULL);
